function showTime() {
	...
	var startDate = new Date(2012, 02, 12);
	...
	if (seconds < 10)
	seconds = "0" + seconds;
	var currentTimeString = "Dear Vivian(孙梦伟):<br>"
		+ "We have already got marital:<br> "
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----胡泊2016-01-12   2012-02-12</c>";
